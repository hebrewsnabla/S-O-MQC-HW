...
\begin{minipage}{0.3\linewidth}
	...
	\end{tikzpicture}
\end{minipage}
$ = \qty(\dfrac{1}{2})^3 (-1)^{2+l} \sum_{} \dfrac{\Braket{ab||ru} \Braket{ru||ts}\Braket{ts||ab}}{(\varepsilon_a + \varepsilon_b - \varepsilon_u - \varepsilon_r)(\varepsilon_a + \varepsilon_b - \varepsilon_s - \varepsilon_t)} $
