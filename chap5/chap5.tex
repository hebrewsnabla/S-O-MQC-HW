...
For $ \eqref{5.2b} $
\begin{align}
\Braket{\Psi_{1_i\bar{1}_i}^{2_i\bar{2}_i} | \sH | \Psi_0} + \sum_{jk} \Braket{\Psi_{1_i\bar{1}_i}^{2_i\bar{2}_i} | \sH - E_0 | \Psi_{1_i\bar{1}_i}^{2_j\bar{2}_k}} c_{1_i\bar{1}_i}^{2_j\bar{2}_k}  &= e_{1_i\bar{1}_i} c_{1_i\bar{1}_i}^{2_i\bar{2}_i} 
\end{align}
