...
\begin{equation}\label{key}
\begin{aligned}
\mathscr{E} &= \dfrac{\Braket{\tilde{\Psi} | -\tfrac{1}{2}\dv[2]{x}-\delta(x) | \tilde{\Psi}}}{\Braket{\tilde{\Psi} | \tilde{\Psi}}} = \dfrac{N^2 \intdinf\dd x \e^{-\alpha x^2}\qty[-\dfrac{1}{2}(-2\alpha+4\alpha^2 x^2) - \delta(x)]\e^{-\alpha x^2}}{N^2\intdinf\dd x \e^{-2\alpha x^2}}\\
...
\begin{equation}\label{key}
\begin{aligned}
\mathscr{E} &= \dfrac{\Braket{\tilde{\Psi} | -\dfrac{1}{2}\nabla^2 - \dfrac{1}{r} | \tilde{\Psi}}}{\Braket{\tilde{\Psi} | \tilde{\Psi}}} = \dfrac{N^2 \cdot 4\pi \intdinf r^2\dd r \e^{-\alpha r^2}\qty[-\dfrac{1}{2}(4 \alpha^2 r^2 - 6\alpha ) - \dfrac{1}{r}]\e^{-\alpha r^2}}{N^2\cdot 4\pi \intdinf r^2\dd r \e^{-2\alpha r^2}}\\
