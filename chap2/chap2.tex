...
\begin{equation}\label{key}
\begin{aligned}
a_r^\dagger a_a\ket{\Psi_0} &= a_r^\dagger a_a (-\ket{\chi_a\cdots\chi_1\chi_b\cdots\chi_N}) = -a_r^\dagger\ket{\cdots\chi_1\chi_b\cdots\chi_N}\\
&= -\ket{\chi_r\cdots\chi_1\chi_b\cdots\chi_N} = \ket{\chi_1\cdots\chi_r\chi_b\cdots\chi_N}\\
&= \ket{\Psi_a^r}
\end{aligned}
\end{equation}
\subex{d.}
