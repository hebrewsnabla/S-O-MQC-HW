...
Since
\begin{align}
\Sigma_{11}^{(2)}(E) &= \dfrac{K_{12}}{E + \varepsilon_1 - 2\varepsilon_2} \\
\Sigma_{11}^{(3)}(E) &= 
\dfrac{K_{12}^2 (J_{22} - 2J_{12} + K_{12})}{(E - 2\varepsilon_2 + \varepsilon_1)^2} 
+ \dfrac{K_{12}^2 (J_{11} - 2J_{12} + K_{12})}{(E - 2\varepsilon_2 + \varepsilon_1)(\varepsilon_1 - \varepsilon_2)}
