...
\begin{align}
\Braket{\Psi_a^r | \mathcal{O}_2 | \Psi_0} &= \dfrac{1}{2} \sum_{ijkl} \left( \Braket{rj|al}\Braket{\Psi_0 | a_j^\dagger  a_l | \Psi_0} - \Braket{rj|ka}\Braket{\Psi_0 | a_j^\dagger  a_k | \Psi_0}\right. \notag\\
&  \left. \hspace{40pt} {} - \Braket{ir|al}\Braket{\Psi_0 | a_i^\dagger  a_l | \Psi_0} + \Braket{ir|ka}\Braket{\Psi_0 | a_i^\dagger  a_k | \Psi_0}\right)
\end{align}
