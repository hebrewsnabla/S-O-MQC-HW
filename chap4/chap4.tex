...
+ \bar\psi_i(1)\bar\psi_j^*(1')] \notag\\
&=  \sum_{ij} (\vb{U}\vb{d}^2\vb{U}^\dagger)_{ij} \qty[\sum_k U^*_{ki}\zeta_k(1)\sum_l U_{lj}\zeta_l^*(1')
+ \sum_k U^*_{ki}\bar\zeta_k(1)\sum_l U_{lj}\bar\zeta_l^*(1')] \notag\\
%
&= \sum_k \sum_m d^2_m \qty[\zeta_k(1) \zeta_k^*(1')
